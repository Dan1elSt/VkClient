...
def main():
    ...
    def get_token(event):
        ...
        y_n = tk.messagebox.askyesno(message="Redirect to get a token?")
        if y_n is True:
            webbrowser.open(url="https://oauth.vk.com/authorize?client_id=6121396&scope=135170&redirect_uri=https://oauth.vk.com/blank.html&display=page&response_type=token&revoke=0", new=2)     
